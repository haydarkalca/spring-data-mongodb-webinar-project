...
interface TweetDAO {
     ...
     *
     * @param followersCount for example: type 100000 which points the number of followers for the lower bound
     * @return AggregationResults which contains the list of {@link TweetDAOImpl.TwitterStats}
     */
    AggregationResults<TweetDAOImpl.TwitterStats> findUsersByFollowersGreaterThan(int followersCount);
