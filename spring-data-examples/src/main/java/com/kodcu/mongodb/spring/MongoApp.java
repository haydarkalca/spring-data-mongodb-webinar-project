...
//        final ApplicationContext ctx = new ClassPathXmlApplicationContext("mongoConfig.xml");
        final AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(MongoConfigurationBeans.class);
        final TweetDAO tweet = ctx.getBean(TweetDAOImpl.class);
        ...
        System.out.println(tweet.findTweetBy("553bbecae8f1e57878b72a25"));
        ...
        AggregationResults<TweetDAOImpl.TwitterStats> tweets = tweet.findUsersByFollowersGreaterThan(followers);
